...
import { Road_LineSegments } from './road_GuLou.js';
import { Bound_LineSegments } from './boundary_GuLou.js';
...
import { initPlane } from './scripts/initPlane_GuLou.js';
// ---------------------------------------------------------------------------------------------------------------------
...
function init() {
    ...
    function initData(){
        map = jsonLoader('meta.json', './data/GuLou/');
        dcj = jsonLoader('IDR_500_8219.json', './data/');
        dcj_his = jsonLoader('IDR_history_MainShock_field_a.json', './data/GuLou/');
        dcj_his.dcj_his = dcj_his.dcj_his.concat(jsonLoader('IDR_history_MainShock_field_b.json', './data/GuLou/').dcj_his);
        console.log(dcj_his)
        ...
        road_pos = jsonLoader('road.json', './data/GuLou/').roads;
        bound_pos = jsonLoader('boundary.json', './data/GuLou/').boundary;
    }
    function initStats() {
...
function update_IDR(){
    ...
    // dcj_his = jsonLoader(file2, './data/GuLou/');
    dcj_his = jsonLoader('IDR_history_MainShock_field_a.json', './data/GuLou/');
    dcj_his.dcj_his = dcj_his.dcj_his.concat(jsonLoader('IDR_history_MainShock_field_b.json', './data/GuLou/').dcj_his);
    max_time_step = dcj_his.length;
    parent.vm.max_time_step = Math.ceil(dcj_his.length / sample_rate);
