...
export default {
  ...
  template: `
    ...
    >
      <v-row no-gutters>
        <v-col cols="1" class="d-flex align-center pl-8">
        ...
        <v-col cols="7">
          <v-tabs class="grey darken-4 pl-2">
            <v-tab @click="handleTabClick(1)" class="text-h6">概览</v-tab>
            <v-tab @click="handleTabClick(2)" class="text-h6">属性</v-tab>
            <v-tab @click="handleTabClick(3)" class="text-h6">工具</v-tab>
          </v-tabs>
        </v-col>
      </v-row>
    </v-app-bar>
